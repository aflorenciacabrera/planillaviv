                        ...
                        <tbody>
                         ...
                         @if ($datos->id == $viviendas->dato_id )
                            <tr>
                                ...
                                <td> <a   href="{{url('encargado/planilla/ver/datos/'.$datos->id)}}" class="btn btn-primary"  role ="button" ><i class="fa fa-edit"></i></a> </td>
                                <td> <a   href="{{url('encargado/planilla/ver/datos/'.$datos->id)}}" class="btn btn-danger"  role ="button" > <i class="fa fa-trash-o"></i></a> </td>
                            </tr>
